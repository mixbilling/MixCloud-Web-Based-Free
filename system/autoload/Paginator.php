...
Class Paginator
{
    public static function bootstrap($table, $w1='',$c1='', $w2='', $c2= '', $w3='',$c3='', $w4='', $c4= '', $per_page = '10')
    {
        ...
        if ($lastpage >= 1) {
            ...
            if ($page == $lastpage AND $page == 1) {
                $pagination .= "<li class='disabled'><a class='disabled' href='{$url}$prev'>".$_L['Previous']."</a></li>";                
				$pagination .= "<li class='disabled'><a class='disabled' href='{$url}$next'>".$_L['Next']."</a></li>";			
            }else if ($page == $lastpage AND $page != 1) {
                $pagination .= "<li><a href='{$url}$prev'>".$_L['Previous']."</a></li>";                
				$pagination .= "<li><a href='{$url}1'>".$_L['First']."</a></li>";
            }else if ($page == 1) {
