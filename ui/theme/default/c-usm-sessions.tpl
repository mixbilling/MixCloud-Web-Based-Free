			...
			<script>
				function remove() {
					if(confirm('{$_L["API_Remove_Alert"]}')){
						document.getElementById("usm_session").setAttribute("action", "{$_url}user-manager/remove-selected-session");
								...
								<div class="panel-body">
									...
									<div class="adv-table table-responsive">
										<form id="usm_session" method="post" role="form">
											<table  class="display table table-bordered table-bordered" id="c-usm-sessions">
												<thead>
