{include file="sections/header.tpl"}
			...
			<script>				
				function enable() {
					document.getElementById("usm_users").setAttribute("action", "{$_url}user-manager/enable-selected-usm_users");
					document.forms['usm_users'].submit();
				}
				function disable() {
					document.getElementById("usm_users").setAttribute("action", "{$_url}user-manager/disable-selected-usm_users");
					document.forms['usm_users'].submit();
				}
				function remove() {
					if(confirm('{$_L["API_Remove_Alert"]}')){
						document.getElementById("usm_users").setAttribute("action", "{$_url}user-manager/remove-selected-usm_users");
						document.forms['usm_users'].submit();
					}	
				}					
			</script>
								...
								<div class="panel-body">
									<div class="group">
										<div style="margin-top:4px;" class="dropdown "><a style="width:170px" href="#" class="dropdown-toggle btn btn-success waves-effect" data-toggle="dropdown" aria-expanded="false"><i class="ion ion-navicon-round"></i> {$_L['Option_Menu']}<span class="caret"></a></span>
											<ul style="margin-left:2px;width:auto;min-width:168px" class="dropdown-menu">	
												...
												<li><a href="{$_url}user-manager/c-print-voucher" target="_blank" title="OPEN PRINT PAGE"><i class="ion ion-ios-sunny"></i> Open Print Page</a></li>
									...
									<div class="adv-table table-responsive">
										<form id="usm_users" method="post" role="form">
											<table class="display table table-bordered table-bordered" id="c-usm-users">
												<thead>
