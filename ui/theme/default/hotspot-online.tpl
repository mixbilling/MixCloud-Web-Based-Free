			...
			<script>
				function remove() {
					if(confirm('{$_L["API_Remove_Alert"]}')){
						document.getElementById("hs_session").setAttribute("action", "{$_url}mikrotik/remove-selected-hs_session");
						document.forms['hs_session'].submit();
					}
				}					
			</script>
			...
			<div class="content-wrapper">
				<section class="content">
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="panel">
								<div class="panel-heading">{$_L['Hotspot_Online']}</div>
								<div class="panel-body">
									...
									<div class="adv-table table-responsive">
										<form id="hs_session" method="post" role="form">
											<table  class="display table table-bordered table-bordered" id="hotspot-online">
												<thead>
													<tr>
