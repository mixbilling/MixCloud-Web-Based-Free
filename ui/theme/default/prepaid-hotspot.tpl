			...
			<div class="content-wrapper">
				<section class="content">
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="panel">
								<div class="panel-heading">{$_L['Prepaid_Member']} Hotspot</div>
								<div class="panel-body">
									<div class="group">
										<div style="margin-top:4px;margin-bottom:-20px" class="dropdown "><a style="width:170px" href="#" class="dropdown-toggle btn btn-success waves-effect" data-toggle="dropdown" aria-expanded="false"><i class="ion ion-navicon-round"></i> {$_L['Option_Menu']}<span class="caret"></a></span>
											<ul style="margin-left:2px;width:auto;min-width:168px" class="dropdown-menu">
												<li><a href="#add-member" data-toggle="modal" data-target="#add-member" title="ADD NEW HOTSPOT MEMBER"><i class="ion ion-android-add"> </i> {$_L['Add_Member']}</a></li>
												...
												<li><a href="{$_url}prepaid/recharge-hotspot" title="RECHARGE HOTSPOT MEMBER"><i class="ion ion-battery-low"></i> {$_L['Recharge_Member']}</a></li>
												<li><a href="#" onclick="remove();" title="REMOVE SELECTED PREPAID HOTSPOT"><i class="ion ion-trash-a"></i> {$_L['Remove_Selected']}</a></li>												
											</ul>
										</div>						
									</div>
									<br>
									...
									<div class="adv-table table-responsive">
										<form id="member" method="post" role="form" action="{$_url}prepaid/remove-selected" >
											<table  class="display table table-bordered table-bordered" id="prepaid-hotspot">
												<thead>
													<tr>
										...
										<div id="service-plan" class="tab-pane fade in active">
											...
											<div class="form-group">
												...
												{if $_admin['user_type'] eq 'Admin'}
													<select class="form-control select2" name="customer" style="width: 100%" data-placeholder="- {$_L['Select_Owner']} -" required>						
														<option></option>
													{foreach $o as $os}
