			...
			<br>
				<tr>
					...
					<td style="margin-left:-10px;">
						<select id="plan_id" name="planid" style="margin-left:-10px;width:150px;height:21px;">
					...
					<td style="width:210px;">From ID &nbsp;&nbsp;&nbsp;
						<input style="margin-left:-10px;text-align:center;width:40px" type="text" name="from_id" value="{$from_id}">&nbsp;&nbsp;&nbsp; To ID &nbsp;&nbsp;&nbsp;
						<input style="margin-left:-10px;text-align:center;width:40px" type="text" name="limit" value="{$limit}">
					</td>					
					<td>
						<button style="margin-left:0;" type="submit">SUBMIT</button>
