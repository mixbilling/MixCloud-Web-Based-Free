				...
				<section class="content">
					<div class="row">
						...
						<div class="col-sm-12 col-md-6">
							<div class="panel">
								<div class="panel-heading">{$_L['Recharge_Member']}</div>
								<div class="panel-body">
									<form id="modal-form" class="form-horizontal" method="post" role="form" action="{$_url}prepaid/recharge-post" >
										...
										<div class="form-group">
											...
											{if $referer|strstr:"customers/hotspot" || $referer|strstr:"prepaid/hotspot"}
												<input type="radio" id="Hot" name="type" value="Hotspot"> HOTSPOT
												<input disabled style="margin-left:10px;" type="radio" id="POE" name="type" value="PPPOE"> PPPOE
											{else if $referer|strstr:"customers/pppoe" || $referer|strstr:"prepaid/pppoe"}
										...
										<div class="form-group">
											<label class="col-md-2 control-label">{$_L['Active_Plan']}</label>
											<div class="col-md-6">
											{if $active_plan['namebp'] eq ''}
												<input type="text" class="form-control" value="{$_L['No_Active_Plan']}" disabled>
											{else}
												<input type="text" class="form-control" value="{$active_plan['namebp']}" disabled>
											{/if}
											</div>
										</div>							
										<div class="form-group">
