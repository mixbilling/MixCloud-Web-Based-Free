			...
			<script>
				function remove() {
					if(confirm('{$_L["API_Remove_Alert"]}')){
						document.getElementById("limitation").setAttribute("action", "{$_url}mikrotik/remove-selected-limitations");
											...
											<table  class="display table table-bordered table-bordered" id="asc-sort-col-1">
												...
												{foreach $limitations as $limitation}
													...
													{/if}	
														...
														<td>
															<a href="{$_url}mikrotik/usm-limitations-edit&id={$limitation['.id']}&name={$limitation['name']}" id="{$limitation['.id']}" title="EDIT THIS LIMITATION" style="color:#fff;font-size:17px;width:30px;height:30px;" class="btn btn-success btn-sm fa fa-pencil-square-o" aria-hidden="true"></a>
															<a href="{$_url}mikrotik/usm-limitations-remove&id={$limitation['.id']}&name={$limitation['name']}" id="{$limitation['.id']}" title="REMOVE THIS LIMITATION" onClick="return confirm('{$_L['API_Remove_Alert']}')" style="color:#fff;font-size:17px;width:30px;height:30px;" class="btn btn-warning btn-sm cdelete fa fa-trash" aria-hidden="true"></a>
														</td>
													</tr>
												{/foreach}
												</tbody>
